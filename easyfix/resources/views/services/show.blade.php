<x-public-layout :wide="true">
    ...
    <x-slot name="head">
        ...
        {!! json_encode([
            ...
            '@type' => 'BreadcrumbList',
            'itemListElement' => [
                ['@type' => 'ListItem', 'position' => 1, 'name' => 'Home', 'item' => route('home', absolute: true)],
                ['@type' => 'ListItem', 'position' => 2, 'name' => 'Services', 'item' => route('services.index', absolute: true)],
                ['@type' => 'ListItem', 'position' => 3, 'name' => $service['name'], 'item' => route('services.show', $slug, absolute: true)],
            ],
        ], JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT) !!}
        </script>
        <script type="application/ld+json">
