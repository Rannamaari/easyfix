<x-public-layout>
    ...
    <article class="max-w-3xl mx-auto">
        ...
        {{-- Title --}}
        <h1 class="mt-3 text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white leading-tight">
            {{ $post->title }}
        </h1>

        {{-- Share (below title) --}}
        <div class="flex flex-wrap items-center gap-2 mt-5 mb-10">
            <a href="https://x.com/intent/tweet?url={{ urlencode(route('blog.show', $post->slug)) }}&text={{ urlencode($post->title) }}"
               target="_blank" rel="noopener"
               class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-400 text-xs font-medium hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors">
