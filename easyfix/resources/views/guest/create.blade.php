            ...
            <form action="{{ route('guest.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="border-b pb-6 border-gray-200 dark:border-slate-800">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="inline-flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-slate-200">
                                <input type="checkbox" id="guest_username_toggle" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500 dark:border-slate-700 dark:bg-slate-900">
                            ...
                            <div id="guest_username_wrapper" class="mt-3 hidden">
                                ...
                                @error('guest_username')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                                <p class="mt-1 text-xs text-gray-500 dark:text-slate-400">Use this if you plan to create an account later.</p>
                            </div>
                        </div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-slate-400">* Provide at least a phone number or email so we can reach you.</p>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="service_category_id" class="block text-sm font-medium text-gray-700 dark:text-slate-200">What do you need help with? *</label>
                    ...
                    <div>
                        <label for="service_id" class="block text-sm font-medium text-gray-700 dark:text-slate-200">Specific Service (optional)</label>
