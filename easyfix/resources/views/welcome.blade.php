...
<head>
    ...
    {{-- Alternate Language (for future Dhivehi version) --}}
    <link rel="alternate" hreflang="en" href="https://easyfix.mv/">
            ...
            "itemListElement": [
                {
                    ...
                    "itemOffered": {
                        "@type": "Service",
                        "name": "Plumbing Services in Malé",
                        "description": "Leak repairs, tap fixes, pipe repairs in Malé City and Hulhumalé"
                    }
                },
                {
                    "@type": "Offer",
                    "itemOffered": {
                        "@type": "Service",
                        "name": "AC Repair in Malé",
                        "description": "Air conditioning repair, servicing and troubleshooting in Malé"
                    }
                },
                {
                    "@type": "Offer",
                    "itemOffered": {
                        "@type": "Service",
                        "name": "Electrician Services in Malé",
                        "description": "Electrical repairs, switch fixes, wiring in Malé City"
                    }
                }
            ]
        }
    ...
    <script type="application/ld+json">
    {
        ...
        "mainEntity": [
            ...
            {
                "@type": "Question",
                "name": "Do you work on weekends and Fridays?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes, we work 7 days a week. On Fridays and Saturdays, we are available from 2 PM onwards. Other days we work from 8 AM to 10 PM."
                }
            }
        ]
    }
        ...
        <section id="services" class="py-16 sm:py-20 bg-white dark:bg-slate-950" aria-labelledby="services-heading">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                    @php
                        $services = [
                            ['icon' => 'sun', 'name' => 'AC Repair', 'desc' => 'AC not cooling? We fix it', 'keywords' => 'AC repair Malé'],
                            ['icon' => 'bolt', 'name' => 'Electrician', 'desc' => 'Switches, boards, wiring', 'keywords' => 'electrician Malé'],
                            ['icon' => 'wrench-screwdriver', 'name' => 'Plumber', 'desc' => 'Leaks, taps, blocked pipes', 'keywords' => 'plumber Malé'],
                            ['icon' => 'key', 'name' => 'Door & Locks', 'desc' => 'Handles, hinges, locks', 'keywords' => 'door repair Malé'],
                            ['icon' => 'sparkles', 'name' => 'Cleaning', 'desc' => 'Deep clean, move-out', 'keywords' => 'cleaning service Malé'],
                            ['icon' => 'cube', 'name' => 'Small Moving', 'desc' => 'Furniture, appliances', 'keywords' => 'moving help Malé'],
                        ];
                    @endphp
            ...
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="space-y-4">
                    ...
                    <details class="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 p-4">
                        ...
                        <p class="mt-3 text-gray-600 dark:text-slate-400 text-sm">
                            Yes! We specialize in small, quick fixes that take 1-3 hours. Door handles, leaky taps, electrical switches, wall mounting, furniture assembly - no job is too small.
                        </p>
                    </details>
                </div>
            </div>
