...
class ServicePageController extends Controller
{
    ...
    public static function pages(): array
    {
        return [
            ...
            'cleaning' => [
                'name' => 'Cleaning',
                'title' => 'Home, Deep & Office Cleaning in Malé & Hulhumalé | EasyFix',
                'description' => 'Book home, deep and bathroom cleaning in Malé and Hulhumalé. View EasyFix cleaning prices inclusive of GST, or request a quote for monthly apartment, building and office cleaning.',
                'icon' => 'sparkles',
                ...
                'faqs' => [
                    ['question' => 'Are the listed cleaning prices inclusive of GST?', 'answer' => 'Yes. Every price shown on the EasyFix cleaning page includes GST.'],
                    ['question' => 'Can I book a one-time deep clean?', 'answer' => 'Yes. Choose the matching home size and deep-cleaning option, then include the areas needing attention and your preferred date in your request.'],
                    ['question' => 'Do you offer monthly cleaning for apartments, buildings or offices?', 'answer' => 'Yes. We can arrange recurring monthly cleaning for apartments, buildings and offices. Send us the location, size and preferred frequency on WhatsApp for a quote.'],
                    ['question' => 'How do I get a quote for office or move-out cleaning?', 'answer' => 'Contact us on WhatsApp with photos, the location, approximate size, required date and the type of cleaning. We will review the details and provide a tailored quote.'],
